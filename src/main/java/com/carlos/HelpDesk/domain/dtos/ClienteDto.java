...
public class ClienteDto implements Serializable {
  ...
  /**
   * Construtor que inicializa os atributos do DTO com base em um objeto Cliente.
   *
   * @param obj O objeto Cliente a partir do qual os atributos do DTO serão inicializados.
   */
